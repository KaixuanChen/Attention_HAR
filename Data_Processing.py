...
def PAMAP_Image(file_data):
    ...
    for line in file_data:
        line_split = []
        line_split.append([line[0], line[17], line[34]]) # hand temperature, chest temperature, ankle temperature
        line_split.append(line[1:4]) # hand acceleration1
        line_split.append(line[4:7]) # hand acceleration2
        line_split.append(line[7:10]) # hand gyroscope
        line_split.append(line[10:13]) # hand magnetometer
        line_split.append(line[18:21]) # chest acceleration1
        line_split.append(line[21:24]) # chest acceleration2
        line_split.append(line[24:27]) # chest gyroscope
        line_split.append(line[27:30]) # chest magnetometer
        line_split.append(line[35:38]) # ankle acceleration1
        line_split.append(line[38:41]) # ankle acceleration2
        line_split.append(line[41:44]) # ankle gyroscope
        line_split.append(line[44:47]) # ankle magnetometer
        line_split.append(line[51:54]) # time, label, subject
        new_line = []
